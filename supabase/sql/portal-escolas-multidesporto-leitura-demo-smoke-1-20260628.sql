-- Portal das Escolas - MULTIDESPORTO-LEITURA-DEMO-SMOKE-1.
-- Smoke test read-only para validar os dados lidos pela página /portal-escolas/multidesporto-demo.
...
checks as (
  ...
  select
    '03_demo_ranking' as check_group,
  ...
  select
    '04_demo_ranking_entries' as check_group,
  ...
  select
    '05_expected_totals' as check_group,
    'demo_multisport_read_model' as object_name,
