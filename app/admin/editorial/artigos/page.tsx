...
export default function AdminEditorialArticlesPage() {
  return (
    <main className="editorial-entry-shell">
      ...
      <section className="editorial-entry-hero">
        <div>
          ...
          <span>Área reservada à organização editorial de artigos e notícias.</span>
        </div>
      ...
      <section className="editorial-entry-note">
        <p>Esta área fica preparada como ponto de entrada para a futura gestão de artigos e notícias.</p>
      </section>
    </main>
  );
}
